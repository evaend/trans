...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init($grid, {
  ...
  columns: [[{ field: 'vehicleDepreciationId', checkbox: true }, { field: 'transportToolNo', title: '运输工具', width: 120 }, { field: 'vehicleAssets', title: '资产总值', width: 120 }, { field: 'serviceLife', title: '使用年限', width: 120 }, { field: 'monthlyDepreciation', title: '月折旧额', width: 120 }]]
});
