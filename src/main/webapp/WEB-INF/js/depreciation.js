...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__component_message__ = __webpack_require__(43);
...
var $grid = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#depreciationGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#depreciationDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#depreciationFf');
...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    iconCls: 'icon-add',
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["d" /* resetFormData */])($form);
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__actions_grid__["a" /* gridEdit */])($grid, function (rows) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["c" /* setFormData */])($form, rows[0], function () {
          __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#serviceBeginYear').combobox('setValue', rows[0].serviceBeginYear);
        });
    ...
    handler: function handler() {
      ...
      // 后台交互
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["b" /* ajaxPost */])({ url: '../operationCosts/deleteInsurances', data: { vehicleDepreciationIds: vehicleDepreciationIds } }, function (data) {
  ...
  title: '车辆折旧表',
  url: '../operationCosts/searchVehicleDep',
  height: __WEBPACK_IMPORTED_MODULE_5_jQuery___default()(window).height() - 65,
  columns: [[{ field: 'vehicleDepreciationId', checkbox: true }, { field: 'transportToolNo', title: '运输工具', width: 120 }, { field: 'serviceBeginYear', title: '开始使用年限', width: 120 }, { field: 'vehicleAssets', title: '资产总值', width: 120 }, { field: 'serviceLife', title: '使用年限', width: 120 }, { field: 'monthlyDepreciation', title: '月折旧额', width: 120 }]]
});
...
__WEBPACK_IMPORTED_MODULE_1__component_window__["a" /* modalWindow */].init($dialog, { title: '编辑' }, function (text) {
  ...
  console.log(isValid);
  if (isValid) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["b" /* ajaxPost */])({ url: '../operationCosts/addUpdateVehiceDep', data: postData }, function (data) {
      //===== 校验结束 =====
...
//计算 serviceLife vehicleAssets
__WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#serviceLife, #vehicleAssets').on('input', function () {
  __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#monthlyDepreciation').val(count());
});

var count = function count() {
  var reg = /^[1-9]\d*(\.\d+)?$/;
  var serviceLife = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#serviceLife').val(),
      vehicleAssets = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#vehicleAssets').val();
  var value = 0;
  if (reg.test(serviceLife) && reg.test(vehicleAssets)) {
    value = vehicleAssets / serviceLife / 12;
  }
