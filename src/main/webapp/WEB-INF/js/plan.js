...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* unused harmony export cascade */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck__);
...
var params = {
  selectors: [$('#brand'), $('#cx')],
  url: '../../lib/mock/brand.json',
  children: ['../../lib/mock/model1.json']
};
      ...
      var _loop = function _loop(i) {
        ...
        if (children[i] && selectors[i + 1]) {
          opts.onSelect = function (record) {
            selectors[i + 1].combobox('reload', children[i] + '?id=' + record.id);
          };
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component_cascade__ = __webpack_require__(49);
...
var $grid = __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#planGrid'),
    ...
    combobox = {
  locationFrom: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }],
  locationTo: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }],
  locationFromCombobox: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }],
  locationToCombobox: [{ id: 1, text: '武汉' }, { id: 2, text: '重庆' }]
};
...
__WEBPACK_IMPORTED_MODULE_1__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    iconCls: 'icon-add',
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_common__["a" /* resetFormData */])($form, function () {
  ...
  columns: [[{ field: 'consignId', checkbox: true }, { field: 'consignNo', title: '制单日期', width: 100 }, { field: 'consignNo', title: '运单号', width: 100 }, { field: 'chassisNo', title: '底盘号', width: 100 }, { field: 'camount', title: '数量', width: 100, align: 'right' }, { field: 'locationFrom', title: '起运地', width: 100 }, { field: 'locationTo', title: '目的地', width: 100 }, { field: 'carBrand', title: '品牌', width: 100 }, { field: 'carModel', title: '车型', width: 100 }, { field: 'transportTool', title: '轿运车', width: 100 }, { field: 'name9', title: '车次', width: 100 }, { field: 'consignOrgName', title: '托运单位', width: 100 }, { field: 'receiveOrgName', title: '收车单位', width: 100 }, { field: 'carrierName', title: '承运商', width: 100 }, { field: 'despatchDate', title: '发运日期', width: 100 }]]
});

//查询按钮
__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#search').on('click', function () {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_common__["c" /* getFormData */])(__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#ff'));
  //刷新表格
  __WEBPACK_IMPORTED_MODULE_1__component_table__["a" /* table */].load($grid, postData);
});

__WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].init($dialog, { title: '车辆信息' }, function (text) {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_common__["c" /* getFormData */])($form);
  //===== 校验 =======
  //===== 校验结束 =====
...
//编板
__WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].init($bbDialog, { title: '编板' }, function (text) {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_common__["c" /* getFormData */])($bbForm);
  //===== 校验 =======
  //===== 校验结束 =====
  console.log('编板一条记录', postData);
  //新增成功,关闭窗口
  __WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].close($bbDialog);
  __WEBPACK_IMPORTED_MODULE_5__component_message__["a" /* message */].alert({
    msg: '\u7F16\u677F\u6210\u529F'
  });
});
...
__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#carrierName').combobox({
  ...
  onSelect: function onSelect(rec) {
    ...
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbYd').combobox('setValue', '');
    var url = '../../lib/mock/model2.json?id=' + rec.id;
...
__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#make').on('click', function () {
  ...
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_common__["a" /* resetFormData */])($bbForm, function () {
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#carrierName').combobox('setValue', '');
    __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#transportTool').combobox('setValue', '');
  });
  var opts = [];
  selectd.map(function (item, index) {
    return opts.push({ id: item.id, text: item.name1 });
  });
  __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#bbYd').combobox({
    data: opts,
    width: 200,
    height: 28,
    valueField: 'id',
  ...
  __WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].open($bbDialog);
});
...
//导入按钮
__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#import').on('click', function () {
  alert(3);
});
...
for (var key in combobox) {
  var param = {};
  var val = combobox[key];
  if (__WEBPACK_IMPORTED_MODULE_7_jQuery___default.a.isArray(val)) {
    param = { data: val };
  } else {
    param = { url: val };
  }
  __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#' + key).combobox(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, param, {
    valueField: 'id',
    textField: 'text'
  }));
}
