...
__WEBPACK_IMPORTED_MODULE_1__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
        ...
        // 后台交互
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["d" /* ajaxPost */])({ url: '../operationCosts/deleteInsurances', data: { insuranceIds: insuranceIds } }, function (data) {
  ...
  columns: [[{ field: 'insuranceId', checkbox: true }, { field: 'insuranceNo', title: '保险单号', width: 150 }, { field: 'insuranceType', title: '种类', width: 100 }, { field: 'insuranceAmount', title: '金额', width: 120 }, { field: 'insuranceCompany', title: '保险公司', width: 260 }]]
});
...
__WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].init($dialog, { title: '编辑' }, function (text) {
  ...
  if (isValid) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["d" /* ajaxPost */])({ url: '../operationCosts/addUpdateInsurance', data: postData }, function (data) {
      //===== 校验结束 =====
