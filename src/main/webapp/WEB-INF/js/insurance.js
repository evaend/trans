...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__component_table__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__component_window__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_common__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__actions_grid__ = __webpack_require__(46);
...
var $grid = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#insuranceGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#insuranceDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#insuranceFf'),
    combobox = {
  zl: [{ id: "交强险", text: '交强险' }, { id: "货物险", text: '货物险' }, { id: "第三者责任险", text: '第三者责任险' }]
};
...
__WEBPACK_IMPORTED_MODULE_1__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["d" /* resetFormData */])($form, function () {
        __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#zl').combobox('setValue', '');
      });
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["a" /* gridEdit */])($grid, function (rows) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["c" /* setFormData */])($form, rows[0], function () {
          __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#zl').combobox('setValue', rows[0].insuranceType);
          __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#insuranceYear').combobox('setValue', rows[0].insuranceYear);
        });
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
        ...
        rows.map(function (item, index) {
          return insuranceIds.push(item.insuranceId);
        });
        // 后台交互
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["b" /* ajaxPost */])({ url: '../operationCosts/deleteInsurances', data: { insuranceIds: insuranceIds } }, function (data) {
  ...
  title: '保险表',
  url: '../operationCosts/searchInsurance',
  height: __WEBPACK_IMPORTED_MODULE_6_jQuery___default()(window).height() - 65,
  columns: [[{ field: 'insuranceId', checkbox: true }, { field: 'insuranceYear', title: '年份', width: 120 }, { field: 'insuranceNo', title: '保险单号', width: 150 }, { field: 'insuranceType', title: '种类', width: 100 }, { field: 'insuranceAmount', title: '金额', width: 120 }, { field: 'insuranceCompany', title: '保险公司', width: 260 }]]
});

//编辑window初始化
__WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].init($dialog, { title: '编辑' }, function (text) {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["a" /* getFormData */])($form);
  //===== 校验 =======
  //===== 校验 =======
  var isValid = $form.form('validate');
  if (isValid) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["b" /* ajaxPost */])({ url: '../operationCosts/addUpdateInsurance', data: postData }, function (data) {
      //===== 校验结束 =====
...
for (var key in combobox) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_6_jQuery___default.a.isArray(val)) {
    param = { data: val };
  } else {
    param = { url: val };
  }
  __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#' + key).combobox(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, param, {
    valueField: 'id',
    textField: 'text',
    width: 200,
    height: 28
