...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_common__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component_message__ = __webpack_require__(43);
...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init(__WEBPACK_IMPORTED_MODULE_4_jQuery___default()('#waybillGrid'), {
  ...
  columns: [[{ field: 'consignDetailId', checkbox: true }, { field: 'createDate', title: '制单日期', width: 150 }, { field: 'consignNo', title: '运单号', width: 200 }, { field: 'carrierName', title: '承运商', width: 260 }, { field: 'consignFsate', title: '状态', width: 70, formatter: function formatter(value) {
      if (value === "01") {
        return "已返单";
      } else if (value === "02") {
        return "异常单";
  ...
  }, { field: 'camount', title: '数量', width: 70, align: 'right' }, { field: 'locationFrom', title: '起运地', width: 100 }, { field: 'locationTo', title: '目的地', width: 100 }, { field: 'consignOrgName', title: '托运单位', width: 260 }, { field: 'receiveOrgName', title: '收车单位', width: 260 }, { field: 'returnDate', title: '返单时间', width: 150 }, { field: 'exceptionReason', title: '备注', width: 120 }, { field: 'modifyUser', title: '修改人', width: 120 }, { field: 'modifyDate', title: '修改时间', width: 150 }]]
});
