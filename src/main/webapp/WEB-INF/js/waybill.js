...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init(__WEBPACK_IMPORTED_MODULE_4_jQuery___default()('#waybillGrid'), {
  ...
  columns: [[{ field: 'consignDetailId', checkbox: true }, { field: 'consignNo', title: '制单日期', width: 100 }, { field: 'consignNo', title: '发运日期', width: 100 }, { field: 'consignNo', title: '运单号', width: 100 }, { field: 'amount', title: '数量', width: 100, align: 'right' }, { field: 'consignFsate', title: '状态', width: 100 }, { field: 'locationFrom', title: '起运地', width: 100 }, { field: 'locationTo', title: '目的地', width: 100 }, { field: 'consignOrgName', title: '托运单位', width: 100 }, { field: 'receiveOrgName', title: '收车单位', width: 100 }, { field: 'carrierName', title: '承运商', width: 100 }, { field: 'name9', title: '是否带单', width: 100 }, { field: 'name10', title: '返单时间', width: 100 }, { field: 'exceptionReason', title: '备注', width: 100 }, { field: 'name11', title: '修改人', width: 100 }, { field: 'modifyDate', title: '修改时间', width: 100 }]]
});
...
__WEBPACK_IMPORTED_MODULE_1__component_window__["a" /* modalWindow */].init(__WEBPACK_IMPORTED_MODULE_4_jQuery___default()('#waybillDialog'), { title: '批量修改' }, function () {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["c" /* getFormData */])(__WEBPACK_IMPORTED_MODULE_4_jQuery___default()('#waybillFf'));
  //===== 校验 =======
  //===== 校验结束 =====
...
__WEBPACK_IMPORTED_MODULE_4_jQuery___default()('#search').on('click', function () {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["c" /* getFormData */])(__WEBPACK_IMPORTED_MODULE_4_jQuery___default()('#ff'));
  //刷新表格
