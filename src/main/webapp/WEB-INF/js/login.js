...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_common__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_md5__ = __webpack_require__(91);
...
var $form = __WEBPACK_IMPORTED_MODULE_2_jQuery___default()('#loginForm'),
    $userNo = __WEBPACK_IMPORTED_MODULE_2_jQuery___default()('#userNo'),
    $pwd = __WEBPACK_IMPORTED_MODULE_2_jQuery___default()("#pwd");
$userNo.on('blur', function () {
    if ($userNo.val().length === 0) {
        __WEBPACK_IMPORTED_MODULE_2_jQuery___default()("#errMsg").removeClass("hidden");
        __WEBPACK_IMPORTED_MODULE_2_jQuery___default()("#errMsg").html("账号不能为空！");
    } else {
        __WEBPACK_IMPORTED_MODULE_2_jQuery___default()("#errMsg").addClass("hidden");
    }
});
$pwd.on('blur', function () {
    if ($pwd.val().length === 0) {
        __WEBPACK_IMPORTED_MODULE_2_jQuery___default()("#errMsg").removeClass("hidden");
        __WEBPACK_IMPORTED_MODULE_2_jQuery___default()("#errMsg").html("密码不能为空！");
    } else {
        __WEBPACK_IMPORTED_MODULE_2_jQuery___default()("#errMsg").addClass("hidden");
    }
});

__WEBPACK_IMPORTED_MODULE_2_jQuery___default()('#loginBtn').on('click', function () {
    var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_common__["a" /* getFormData */])(__WEBPACK_IMPORTED_MODULE_2_jQuery___default()('#loginForm'));
    postData.pwd = __WEBPACK_IMPORTED_MODULE_1_md5___default()(postData.pwd);
