...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init($grid, {
  ...
  columns: [[{ field: 'id', checkbox: true }, { field: 'sendDate', title: '发运日期', width: 100 }, { field: 'consignNo', title: '运单号', width: 100 }, { field: 'chassisNo', title: '底盘号', width: 100 }, { field: 'locationFrom', title: '起运地', width: 100 }, { field: 'locationTo', title: '目的地', width: 100 }, { field: 'carBrand', title: '品牌', width: 100 }, { field: 'carModel', title: '车型', width: 100 }, { field: 'amount', title: '数量', width: 100, align: 'right' }, { field: 'consignOrgName', title: '托运单位', width: 100 }, { field: 'freightRates', title: '运价', width: 100 }, { field: 'freight', title: '运费', width: 100 }, { field: 'subsidy', title: '补贴', width: 100 }, { field: 'qualityLoss', title: '质损费', width: 100 }, { field: 'misCosts', title: '杂项扣费', width: 100 }, { field: 'gpsPayment', title: 'GPS扣款', width: 100 }, { field: 'reverseCharge', title: '倒板费', width: 100 }, { field: 'advances', title: '预付款', width: 100 }, { field: 'prepaidOilCard', title: '预付油卡', width: 100 }, { field: 'bill', title: '计费金额', width: 100 }, { field: 'modifyUserName', title: '修改人', width: 100 }, { field: 'modifyDate', title: '修改时间', width: 100 }]]
});
