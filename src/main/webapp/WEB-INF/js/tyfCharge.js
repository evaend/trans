...
__WEBPACK_IMPORTED_MODULE_1__component_window__["a" /* modalWindow */].init($dialog, { title: '编辑' }, function (text) {
  var selectd = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["e" /* jsonNull */])(__WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#tyfChargeGrid').datagrid('getSelections'), 0);
