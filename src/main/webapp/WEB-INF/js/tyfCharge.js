...
var $grid = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#tyfChargeGrid'),
...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init($grid, {
  ...
  columns: [[{ field: 'chargeId', checkbox: true },
  //{field:'createDate',title:'制单日期',width:150},  
  { field: 'despatchDate', title: '发运日期', width: 120 }, { field: 'consignNo', title: '运单号', width: 200 }, { field: 'chassisNo', title: '底盘号', width: 200 }, { field: 'chargeFstate', title: '状态', width: 70, formatter: function formatter(value) {
      if (value === "01") {
        return "已对账";
      } else if (value === "00") {
        return "未对账";
...
__WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#export').attr('href', '../charge/exportChargeInfoList?chargeType=01');

//对账
__WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#check').on('click', function () {
  var selectd = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#tyfChargeGrid').datagrid('getSelections');
  var len = selectd.length;
  if (len === 0) {
