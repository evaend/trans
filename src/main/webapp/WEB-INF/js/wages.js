...
var $grid = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#wagesGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#wagesDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#wagesFf');
...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init($grid, {
  ...
  columns: [[{ field: 'salaryId', checkbox: true }, { field: 'salaryYear', title: '年', width: 100 }, { field: 'salaryMonth', title: '月份', width: 100 }, { field: 'pName', title: '姓名', width: 100 }, { field: 'basePay', title: '底薪', width: 100 }, { field: 'positionSalary', title: '岗位工资', width: 100 }, { field: 'evaluationReward', title: '综合考评奖励', width: 100 }, { field: 'trafficCommunications', title: '交通通讯保障', width: 100 }, { field: 'seniorityPay', title: '工龄工资', width: 100, textAlign: 'right' }, { field: 'payRetro', title: '补发', width: 100, textAlign: 'right' }, { field: 'buckleUp', title: '补扣', width: 100, textAlign: 'right' }, { field: 'actualPay', title: '实发工资', width: 100, textAlign: 'right' }]]
});
