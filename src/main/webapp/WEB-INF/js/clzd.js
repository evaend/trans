...
var $grid = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#clzdGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#clzdDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#clzdFf');
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
        ...
        rows.map(function (item, index) {
          opts.push(item.travelAllowanceId);
        });
        // 刷新表格
        // 后台交互
