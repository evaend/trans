...
__WEBPACK_IMPORTED_MODULE_8_jQuery___default()('#search').on('click', function () {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["d" /* getFormData */])(__WEBPACK_IMPORTED_MODULE_8_jQuery___default()('#ff'));
