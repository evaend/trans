...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_common__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component_message__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__actions_grid__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__component_location__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__component_cascade__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_jQuery__ = __webpack_require__(0);
...
var $grid = __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#costGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#costDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#costFf');
//地址初始化      
__WEBPACK_IMPORTED_MODULE_5__component_location__["a" /* location */].init([__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#locationFromSearch'), __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#locationToSearch'), __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#locationFrom'), __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#locationTo')]);
//车型品牌初始化
__WEBPACK_IMPORTED_MODULE_6__component_cascade__["a" /* cascade */].init({
...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    iconCls: 'icon-add',
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["a" /* resetFormData */])($form, function () {
        __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#locationFrom').combobox('setValue', '');
        __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#locationTo').combobox('setValue', '');
        __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#carBrand').combobox('setValue', '');
        __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#carModel').combobox('setValue', '');
      });
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["a" /* gridEdit */])($grid, function (rows) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["b" /* setFormData */])($form, rows[0], function () {
          __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#locationFrom').combobox('setValue', rows[0].departure);
          __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#locationTo').combobox('setValue', rows[0].destination);
          __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#carBrand').combobox('setValue', rows[0].brand);
          __WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#carModel').combobox('setValue', rows[0].models);
        });
    ...
    iconCls: 'icon-remove',
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
  ...
  title: '成本合同表',
  url: '../contractRecords/searchContractInfo?contractType=02',
  columns: [[{ field: 'id', checkbox: true }, { field: 'carrierName', title: '承运商', width: 100 }, { field: 'locationFrom', title: '起运地', width: 100 }, { field: 'locationTo', title: '目的地', width: 100 }, { field: 'carBrand', title: '品牌', width: 100 }, { field: 'carModel', title: '车型', width: 100 }, { field: 'freightRates', title: '运价', width: 100, textAlign: 'right' }, { field: 'chargeCyc', title: '结费周期', width: 100 }, { field: 'contractStart', title: '合同开始日期', width: 100 }, { field: 'contractEnd', title: '合同结束日期', width: 100 }, { field: 'modifier', title: '修改人', width: 100 }, { field: 'modifyDate', title: '修改日期', width: 100 }]]
});

__WEBPACK_IMPORTED_MODULE_1__component_window__["a" /* modalWindow */].init($dialog, { title: '收入合同' }, function (text) {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["c" /* getFormData */])($form);
  //===== 校验 =======
  //===== 校验结束 =====
  var isValid = $form.form('validate');
  if (isValid) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["d" /* ajaxPost */])({ url: '../contractRecords/addUpdateContractInfo', data: postData }, function (data) {
      //===== 校验结束 =====
...
__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#search').on('click', function () {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["c" /* getFormData */])(__WEBPACK_IMPORTED_MODULE_7_jQuery___default()('#ff'));
