...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__component_table__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__component_window__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__actions_grid__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__component_location__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__component_cascade__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_jQuery__ = __webpack_require__(1);
...
var $grid = __WEBPACK_IMPORTED_MODULE_8_jQuery___default()('#costGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_8_jQuery___default()('#costDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_8_jQuery___default()('#costFf');
//地址初始化      
...
__WEBPACK_IMPORTED_MODULE_1__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__actions_grid__["a" /* gridEdit */])($grid, function (rows) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["c" /* setFormData */])($form, rows[0], function () {
          ...
          __WEBPACK_IMPORTED_MODULE_8_jQuery___default()('#consignOrgId').combobox('setValue', rows[0].carrierId);
        });
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
        ...
        // 后台交互
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["b" /* ajaxPost */])({ url: '../contractRecords/deleteContract', data: { contractIds: contractIds } }, function (data) {
  ...
  title: '成本合同表',
  url: '../contractRecords/searchContractInfo',
  queryParams: {
    contractType: '02'
  },
  height: __WEBPACK_IMPORTED_MODULE_8_jQuery___default()(window).height() - 95,
  columns: [[{ field: 'contractId', checkbox: true }, { field: 'carrierId', hidden: true }, { field: 'carrierName', title: '承运商', width: 260 }, { field: 'locationFrom', title: '起运地', width: 100 }, { field: 'locationTo', title: '目的地', width: 100 }, { field: 'carBrand', title: '品牌', width: 100 }, { field: 'carModel', title: '车型', width: 100 }, { field: 'freightRates', title: '运价', width: 100, textAlign: 'right' }, { field: 'chargePeriod', title: '结费周期', width: 70 }, { field: 'contractStart', title: '合同开始日期', width: 120 }, { field: 'contractEnd', title: '合同结束日期', width: 120 }, { field: 'modifyUserName', title: '修改人', width: 120 }, { field: 'modifyDate', title: '修改日期', width: 120 }]]
});

__WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].init($dialog, { title: '收入合同' }, function (text) {
  console.log(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["a" /* getFormData */])($form), 'form');
  var postData = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["a" /* getFormData */])($form), {
    contractType: '02',
    carrierName: __WEBPACK_IMPORTED_MODULE_8_jQuery___default()('#consignOrgId').combobox('getText')
  });
  //===== 校验 =======
  //===== 校验结束 =====
  var isValid = $form.form('validate');
  if (isValid) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["b" /* ajaxPost */])({ url: '../contractRecords/addUpdateContractInfo', data: postData }, function (data) {
      //===== 校验结束 =====
...
__WEBPACK_IMPORTED_MODULE_8_jQuery___default()('#search').on('click', function () {
  var postData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["a" /* getFormData */])(__WEBPACK_IMPORTED_MODULE_8_jQuery___default()('#ff'));
