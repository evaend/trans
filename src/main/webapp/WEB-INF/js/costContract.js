  ...
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
        // 后台交互
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["d" /* ajaxPost */])({ url: '../contractRecords/deleteContract', data: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, rows, { contractType: '02' }) }, function (data) {
