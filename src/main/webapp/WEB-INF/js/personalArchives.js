...
var $grid = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#personalGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#personalDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#personalFf');
//部门
__WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#departmentId').combobox({
...
__WEBPACK_IMPORTED_MODULE_0__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["a" /* gridEdit */])($grid, function (rows) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["c" /* setFormData */])($form, rows[0], function () {
          __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#pGender').combobox('setValue', rows[0].pGender);
          __WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#departmentId').combobox('setValue', rows[0].departmentId);
        });
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
        var personRecordsIds = [];
        rows.map(function (item, index) {
          return personRecordsIds.push(item.personRecordsId);
        });
        // 后台交互
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["d" /* ajaxPost */])({ url: '../personRecords/deletePersonRecords', data: { personRecordsIds: personRecordsIds } }, function (data) {
          console.log('删除数据', personRecordsIds);
          // 刷新表格
  ...
  title: '人事档案表',
  url: '../personRecords/searchPersonRecords', //../../lib/mock/common.json',人事档案列表
  columns: [[{ field: 'personRecordsId', checkbox: true }, { field: 'pName', title: '姓名', width: 100 }, { field: 'pGender', title: '性别', width: 100 }, { field: 'pEmergencyPhone', title: '电话号码', width: 100 }, { field: 'pBirthdate', title: '出生日期', width: 100 }, { field: 'pIdno', title: '身份证号', width: 100 }, { field: 'pHomeAddress', title: '家庭住址', width: 100 }, { field: 'pEmergency', title: '紧急联系人', width: 100 }, { field: 'pEmergencyPhone', title: '紧急联系人电话', width: 100 }, { field: 'pBankCard', title: '银行卡号', width: 100 }, { field: 'remark', title: '备注', width: 100 }, { field: 'modifyUserName', title: '修改人', width: 100 }, { field: 'modifyDate', title: '修改日期', width: 100 }]]
});

__WEBPACK_IMPORTED_MODULE_1__component_window__["a" /* modalWindow */].init($dialog, { title: '人事档案' }, function (text) {
  ...
  if (isValid) {
    //人事档案新增url
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["d" /* ajaxPost */])({ url: '../personRecords/addUpdatePersonRecord', data: postData }, function (data) {
      //===== 校验结束 =====
