...
__WEBPACK_IMPORTED_MODULE_5_jQuery___default()('#departmentId').combobox({
  url: '../personRecords/searchOrgDepartmentForSelect',
  valueField: 'id',
  textField: 'text',
  editable: false,
  width: 200,
  ...
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
        ...
        // 后台交互
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["b" /* ajaxPost */])({ url: '../personRecords/deletePersonRecords', data: { personRecordsIds: personRecordsIds } }, function (data) {
...
__WEBPACK_IMPORTED_MODULE_1__component_window__["a" /* modalWindow */].init($dialog, { title: '人事档案' }, function (text) {
  ...
  if (isValid) {
    //人事档案新增url
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_common__["b" /* ajaxPost */])({ url: '../personRecords/addUpdatePersonRecord', data: postData }, function (data) {
      //===== 校验结束 =====
