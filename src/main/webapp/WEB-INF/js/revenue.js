  ...
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
        ...
        // 后台交互
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["b" /* ajaxPost */])({ url: '../operationCosts/deleteTaxInfo', data: { taxIds: taxIds } }, function (data) {
...
__WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].init($dialog, { title: '编辑' }, function (text) {
  ...
  if (isValid) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["b" /* ajaxPost */])({ url: '../operationCosts/addUpdateTaxInfo', data: postData }, function (data) {
      //===== 校验结束 =====
