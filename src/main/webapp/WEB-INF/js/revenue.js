...
var $grid = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#revenueGrid'),
    $dialog = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#revenueDialog'),
    $form = __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#revenueFf'),
    combobox = {
  taxType: [{ id: '运输', text: '运输' }, { id: '仓储', text: '仓储' }]
};
...
__WEBPACK_IMPORTED_MODULE_1__component_table__["a" /* table */].init($grid, {
  toolbar: [{
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["b" /* resetFormData */])($form, function () {
        __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#sl').combobox('setValue', '');
      });
    ...
    handler: function handler() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__actions_grid__["b" /* gridDelete */])($grid, function (rows) {
        ...
        // 后台交互
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["d" /* ajaxPost */])({ url: '../operationCosts/deleteTaxInfo', data: { taxIds: taxIds } }, function (data) {
  ...
  title: '税收表',
  url: '../operationCosts/searchTaxInfo',
  height: __WEBPACK_IMPORTED_MODULE_6_jQuery___default()(window).height() - 65,
  columns: [[{ field: 'taxId', checkbox: true }, { field: 'taxDate', title: '日期', width: 120 }, { field: 'taxNo', title: '税号', width: 120 }, { field: 'taxType', title: '种类', width: 100 }, { field: 'taxAmount', title: '含税金额', width: 100 }, { field: 'taxRate', title: '税率', width: 100 }, { field: 'taxFreeAmount', title: '不含税金额', width: 100 }]]
});
...
__WEBPACK_IMPORTED_MODULE_2__component_window__["a" /* modalWindow */].init($dialog, { title: '编辑' }, function (text) {
  ...
  if (isValid) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_common__["d" /* ajaxPost */])({ url: '../operationCosts/addUpdateTaxInfo', data: postData }, function (data) {
      //===== 校验结束 =====
...
__WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#sl').combobox({
  data: [{ id: '6%', text: '6%' }, { id: '11%', text: '11%' }],
  valueField: 'id',
  textField: 'text',
  width: 200,
  height: 28,
...
var count = function count() {
  ...
  __WEBPACK_IMPORTED_MODULE_6_jQuery___default()('#taxFreeAmount').val(taxFreeAmount);
};
